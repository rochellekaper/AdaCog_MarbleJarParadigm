...
# Run 'Before Experiment' code from expName_3
...
practice_trials = data.TrialHandler(nReps=1.0, method='fullRandom', 
    ...
    trialList=data.importConditions('practice_orange_green_purple.xlsx'),
...
which_trial = data.TrialHandler(nReps=1.0, method='fullRandom', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('condition_file_orange_green_purple.xlsx'),
