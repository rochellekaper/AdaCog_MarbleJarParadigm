...
def generate_marblejar_right_left(amount_of_jars, whichjar): 
    ...
    for i in range(amount_of_jars):
        ...
        #img.show()
        img.save(r'/Users/rochellekaper/Desktop/Both_Tasks/green_orange_purple/Stimuli/reg_trials/marblejar'+"_"+str(whichjar)+"_"+str(i)+".jpg")
        img_list.append(img)
    
    files = list(zip(glob.glob('/Users/rochellekaper/Desktop/Both_Tasks/green_orange_purple/Stimuli/reg_trials/*.jpg')))
...
def generate_jar3(jar_images, list_jar3, whichjar):
    ...
    for i, j in enumerate(list_jar3):
        if j == 'same':
            jar_images[i].save(r'/Users/rochellekaper/Desktop/Both_Tasks/green_orange_purple/Stimuli/reg_trials/marblejar3'+"_"+ whichjar+"_"+str(j)+"_"+str(i)+".jpg")
        ...
        if j == 'different':
            ...
            #img.show()
            img.save(r'/Users/rochellekaper/Desktop/Both_Tasks/green_orange_purple/Stimuli/reg_trials/marblejar3'+"_"+str(whichjar)+"_"+str(j)+"_"+str(i)+".jpg")
            img_list.append(img)
            
    files = list(zip(glob.glob('/Users/rochellekaper/Desktop/Both_Tasks/green_orange_purple/Stimuli/reg_trials/marblejar3*.jpg')))
    files = natsorted(files)
...
def specify_jar_pts(points, num_jars): #takes in total amount of points you want jar to equal & how many jars being generated (multiples of 3)
    ...
    files = list(zip(glob.glob('/Users/rochellekaper/Desktop/Both_Tasks/green_orange_purple/Stimuli/marblejar_*.jpg')))
    files = natsorted(files)
...
# imgs, files_col = specify_jar_pts(29, 60)
# imgs1, files_col1 = specify_jar_pts(26, 60)
# imgs2, files_col2 = specify_jar_pts(27, 60)
# imgs3, files_col3 = specify_jar_pts(25, 24)
# imgs4, files_col4 = specify_jar_pts(30, 21)

# #write out to text file
# with open("file_colors2.txt", 'w') as f: 
#     for key, value in files_col.items(): 
#         f.write('%s:%s\n' % (key, value))    
        
# with open("file_colors2.txt", 'a') as f: 
