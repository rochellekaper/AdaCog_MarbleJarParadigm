...
def specify_jar_pts(points): #takes in total amount of points you want jar to equal
    ...
    img1.ellipse((95, 165, 155, 225), fill = col_list[7], outline = col_list[7]) #marble 8
    img1.ellipse((165, 165, 225, 225), fill = col_list[8], outline = col_list[8]) #marble 9
    #img.save(r'/Users/rochellekaper/Desktop/AdaCog/Both Tasks/Stimuli/marblejar'+"_"+str(points)+"points"+".jpg")
    return img
...
for i in range(3):
    jar = specify_jar_pts(29)
    #change file name to match points
    jar.save(r'/Users/rochellekaper/Desktop/AdaCog/Both Tasks/Stimuli/marblejar'+"_"+str(29)+"points"+str(i)+".jpg")
    
for i in range(3):
        jar = specify_jar_pts(27)
        #change file name to match points
        jar.save(r'/Users/rochellekaper/Desktop/AdaCog/Both Tasks/Stimuli/marblejar'+"_"+str(27)+"points"+str(i)+".jpg")
