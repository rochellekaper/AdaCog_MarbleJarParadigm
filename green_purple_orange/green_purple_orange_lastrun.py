...
expName = 'green_purple_orange'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/rochellekaper/Desktop/Both_Tasks/green_purple_orange/green_purple_orange_lastrun.py',
...
practice_trials = data.TrialHandler(nReps=1.0, method='fullRandom', 
    ...
    trialList=data.importConditions('practice_green_purple_orange.xlsx'),
...
which_trial = data.TrialHandler(nReps=1.0, method='fullRandom', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('Condition_File_green_purple_orange.xlsx'),
